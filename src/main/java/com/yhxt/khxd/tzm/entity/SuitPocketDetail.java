 ...
 */
@Entity
@Table(name = "suit_pocket_detail")
public class SuitPocketDetail implements Serializable {
  private static final long serialVersionUID = 8400212097779901031L;
  ...
  public SuitPocketDetail() {
  }

  public SuitPocketDetail(String cz, String zx, String lb, String ys, String mb, String yq, BigDecimal gd, BigDecimal kd, BigDecimal hd, Integer mtsl, Integer ts, BigDecimal dj, BigDecimal je, String bz) {
    this.cz = cz;
    this.zx = zx;
    this.lb = lb;
    this.ys = ys;
