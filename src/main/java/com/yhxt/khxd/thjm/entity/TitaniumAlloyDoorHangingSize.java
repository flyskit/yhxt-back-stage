 ...
 */
@Entity
@Table(name = "titanium_alloy_door_hanging_size")
public class TitaniumAlloyDoorHangingSize implements Serializable {
   ...
   * 默认构造器
   */
  public TitaniumAlloyDoorHangingSize() {
  }

  public TitaniumAlloyDoorHangingSize(String lxys, String zx, String bl, String tm, String ms, String bt, String gm, BigDecimal gd, BigDecimal kd, BigDecimal hd, Integer mssl, Integer sl, BigDecimal pf, String bz, BigDecimal dj, BigDecimal je) {
    this.lxys = lxys;
    this.zx = zx;
    this.bl = bl;
    this.tm = tm;
