...
/**
 * @ClassName TitaniumAlloyDoorSwingSize
 * @Author zqi
 ...
 */
@Entity
@Table(name = "titanium_alloy_door_swing_size")
public class TitaniumAlloyDoorSwingSize implements Serializable {
   ...
   * 默认构造器
   */
  public TitaniumAlloyDoorSwingSize() {
  }

  public TitaniumAlloyDoorSwingSize(String lxys, String zx, String bl, String fx, String bd, BigDecimal gd, BigDecimal kd, BigDecimal hd, Integer sl, String bz, BigDecimal dj, BigDecimal je) {
    this.lxys = lxys;
    this.zx = zx;
    this.bl = bl;
    this.fx = fx;
